<template>
  <div class="container">
    <div class="tuyendung-header">
      <h2>Tuyển dụng</h2>
      </div>
    <div class="tuyendung-info">
      <h2 class="tieude">NHÂN VIÊN BÁN HÀNG</h2>

      <b>1.MÔ TẢ</b>
      <ul class="tuyendung-noidung">
        <li>Vui vẻ, lịch sự chào đón khi khách vào cửa hàng.</li>
        <li>
          Tìm hiểu nhu cầu, tư vấn các thông tin về: Sản phẩm, dịch vụ, chương
          trình khuyến mãi, hậu mãi cho khách hàng.
        </li>
        <li>
      ...
      <ul class="tuyendung-noidung">
        ...
        <li>
          Yêu thích công nghệ, giao tiếp, chăm sóc khách hàng. Ưu tiên các ứng
          viên đã làm việc tại các shop bán điện thoại, điện máy.
        </li>
      ...
      <ul class="tuyendung-noidung">
        ...
        <li>
          Phụ cấp, thưởng thêm theo chế độ công ty (Làm thêm, gửi xe, sinh nhật,
          Lễ tết….)
        </li>
      ...
      <ul class="tuyendung-noidung">
        ...
        <li>
          ...
          <b>Phòng Hành chính nhân sự - 95B Phố Biển, Trần Hưng Đạo, TPHCM.</b>
        </li>
