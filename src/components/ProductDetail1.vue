...
export default {
  ...
  computed: {
    ...
    filteredProducts() {
      // Lọc danh sách sản phẩm dựa trên mức giá
      return this.products.filter(product => product.promotionPrice > this.price - 15000000 && product.promotionPrice < this.price + 15000000);
    }
  },
  props: {
    price: Number
